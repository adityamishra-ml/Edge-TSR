...
## Evaluation Dataset
One video fromt the evaluation set has been released for the review purpose. The folder contains the "rain.mp4" and "rain.xml". The full evaluation set will be released soon. [Evaluation Subset](google.com).
